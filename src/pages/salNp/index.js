...
import {Card, Button, Modal, Select, Upload, Icon, message, Input} from 'antd'
import SalNpQuery from './salNpQuery'
import salNpColumns from './column'
import {ajax, urls, Functions, PermissionButton,Constants} from '../../util'
import axios from 'axios'

const Option = Select.Option

class SalNp extends PureComponent {
    state = {
        pageNum: 1,
        loading: true,
        visible: false,
    ...
    displaySearch = () => {
        let index = PermissionButton.get(urls.salNp.route).indexOf('查询')
        if (index >= 0) {
            return (
                <SalNpQuery
                ...
                <div>
                    ...
                    >
                        <Select style={{width: 200}} onChange={this.handleSelectChange} placeholder="请选择类别">
                            ...
                            <Option value="计税专用-加项">计税专用-加项</Option>
                            <Option value="计税专用-减项">计税专用-减项</Option>
                        </Select>
